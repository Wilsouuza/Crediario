...
public class PurchaseService {
    ...
    public PurchaseService(PurchaseRepository purchaseRepository, CustomerService customerService, InstallmentService installmentService, UserService userService) {
